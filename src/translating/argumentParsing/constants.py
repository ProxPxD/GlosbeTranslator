...
class FLAGS:
    ...
    LANG_SPEC_ADJUSTMENT: str = '--lang_specific_adjustment'
...
modes_to_arity_map = {
    ...
    (FLAGS.LANG_LIMIT, FLAGS.LAST, FLAGS.DEFAULT_TRANSLATIONAL_MODE, FLAGS.LANG_SPEC_ADJUSTMENT): 1
}


mode_types_to_modes = {
    ModeTypes.TRANSLATIONAL: {FLAGS.SINGLE, FLAGS.MULTI_WORD, FLAGS.MULTI_LANG},
    ModeTypes.CONFIGURATIONAL: {FLAGS.LANG_LIMIT, FLAGS.SAVED_LANGS, FLAGS.LAST, FLAGS.ADD_LANG, FLAGS.REMOVE_LANG, FLAGS.DEFAULT_TRANSLATIONAL_MODE, FLAGS.LANG_SPEC_ADJUSTMENT},
    ModeTypes.DISPLAYABLE: {FLAGS.LANG_LIMIT, FLAGS.DEFAULT_TRANSLATIONAL_MODE, FLAGS.SETTINGS, FLAGS.HELP, FLAGS.SAVED_LANGS, FLAGS.LANG_SPEC_ADJUSTMENT},
}