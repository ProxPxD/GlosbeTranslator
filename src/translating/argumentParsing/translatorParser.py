...
class TranslatorCli(Cli):
    ...
    def _create_hidden_nodes(self) -> None:
        ...
        self._create_lang_node()
        self._create_word_node()
        self._create_double_node()

    def _create_single_node(self) -> None:
    ...
    def _create_lang_node(self) -> None:
    ...
    def _create_word_node(self) -> None:
    ...
    def _create_double_node(self) -> None:
