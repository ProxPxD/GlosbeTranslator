...
from src.translating.argumentParsing.translatorCli import SINGLE_LONG_FLAG, DEFAULT_MODE_SHORT_FLAG, DEFAULT_MODE_LONG_FLAG, LANG_LIMIT_SHORT_FLAG, \
	LANG_LIMIT_LONG_FLAG, LANG_LONG_FLAG, WORD_LONG_FLAG, LANGS_SHOW_LONG_FLAG, LANGS_SHOW_SHORT_FLAG, LAST_LANG_LONG_FLAG, LAST_2_SHORT_FLAG, LAST_2_LONG_FLAG, \
	LAST_1_SHORT_FLAG, LAST_1_LONG_FLAG, SETTINGS_SHORT_FLAG, SETTINGS_LONG_FLAG, ADD_LANG_SHORT_FLAG, ADD_LANG_LONG_FLAG, REMOVE_LANG_LONG_FLAG, \
	REMOVE_LANG_SHORT_FLAG
